...
, re, perl, ncurses, coqPackages
, ppxlib, ppx_deriving, menhir, menhirLib
, version ? "1.14.1"
}:
with lib;
let fetched = coqPackages.metaFetch ({
    release."1.15.2".sha256 = "0swzqabwrxqb6sz8zpild2lfcnk3l0zxi9fw61dy2g1pzws2j2jy";
...
buildDunePackage rec {
  ...
  propagatedNativeBuildInputs =
    optionals (lib.versionAtLeast version "1.15" || version == "dev")
     [ menhir menhirLib ];
