...
include Makefile.test-suite-stdlib.coq.conf
...
Makefile.test-suite-stdlib.coq.conf: _CoqProject.test-suite-stdlib
	/home/cmarcon/.opam/4.14.1/bin/rocq makefile -f _CoqProject.test-suite-stdlib -o Makefile.test-suite-stdlib.coq

# This file can be created by the user to hook into double colon rules or
# add any other Makefile code they may need
-include Makefile.test-suite-stdlib.coq.local

# Parameters ##################################################################
#
# Parameters are make variable assignments.
# They can be passed to (each call to) make on the command line.
# They can also be put in Makefile.test-suite-stdlib.coq.local once and for all.
...
# put in Makefile.test-suite-stdlib.coq.local double colon rules accordingly.
# E.g. to perform some work after the all target completes you can write
#
# post-all::
# 	echo "All done!"
#
# in Makefile.test-suite-stdlib.coq.local
#
###############################################################################
...
VDFILE := .Makefile.test-suite-stdlib.coq.d
...
#
# There rules can be extended in Makefile.test-suite-stdlib.coq.local
...
VDFILE_FLAGS:=$(if _CoqProject.test-suite-stdlib,-f _CoqProject.test-suite-stdlib,) $(CMDLINE_COQLIBS) $(CMDLINE_VFILES)

$(VDFILE): _CoqProject.test-suite-stdlib $(VFILES)
...
# extension points and Makefile.test-suite-stdlib.coq.local
printenv::
	$(warning printenv is deprecated)
	$(warning write extensions in Makefile.test-suite-stdlib.coq.local or include Makefile.test-suite-stdlib.coq.conf)
	@echo 'COQLIB = $(COQLIB)'
...
# file you can extend the merlin-hook target in Makefile.test-suite-stdlib.coq.local
.merlin:
	$(SHOW)'FILL .merlin'
...
# Users can create Makefile.test-suite-stdlib.coq.local-late to hook into double-colon rules
# or add other needed Makefile code, using defined
# variables if necessary.
-include Makefile.test-suite-stdlib.coq.local-late
