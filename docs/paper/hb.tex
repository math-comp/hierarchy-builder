...
\marginpar{it may worth cheting and removing the @ for this paper, so that
all primitive types are simply in red, while the ones with an ADT in blue.
At some point Elpi will support type abbreviations and no @ will be needed.
Then we can put a footnote in case one peeks at the code.}
...
There is also the Mizar thing~\cite{7733265}, but I need to read it first.
