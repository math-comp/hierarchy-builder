...
handled by \HB{} are subdivided in five categories, the \mixins{}
\(\M{}\), the \factories{} \(\F{}\), \mixinbuilders{} \(\B{}\), the
\classes{} \(\C{}\), the \structures{} \(\Str{}\).
...
In a system based on type classes, such abbreviation could be implemented by tagging \mixins{} as type classes.
In our target language of packed classes such notation relies on unification
