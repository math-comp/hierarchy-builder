...
\newtheorem*{abscommand}{Abstract command}
...
\mixins{} that occur as parameters of \(m\).
\depx{} is trnasitively closed since records are well types
...
\begin{invariant}[\autoref{req:class:inj}]
