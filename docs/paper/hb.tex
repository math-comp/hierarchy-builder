...
are \mixins{} applied to \coq{T} and possibly other \mixins{}. E.g.
\begin{coqcode}
...
\begin{definition}[\FB{}, \factorybuilders{}]
A \factorybuilder{} \(fb \in \FB{}\) is a notation which automatically finds
...
\begin{coqcode}
Record c (T : Type) := { p#$_1$# : m#$_1$# T; p_2 : m_2 T p_1; .. ; p_n : m_n T p_i1 .. p_ik}.
\end{coqcode}
