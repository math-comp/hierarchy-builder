...
\item Operations and properties (axioms) are made available to the user
      ...
      is free to move them from one to another.
...
\item \Packager{}s and \mixins{} cannot disappear but can change considerably
...
\item \HB{} high level commands compile into
      ...
      and Canonical Structures declarations. This lifts a considerable
      burden from the shoulders of the hierarchy designer and the final user
      that are no longer required to master the Packed Classes discipline.
\end{itemize}
...
\marginpar{This command has not this signature}
