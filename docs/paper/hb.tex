...
We comment these two builtin predicates
while looking at the code that declares the structure record given the
name of the class and produces three terms: the structure and the two
projections. TODO: @factoryname -> @classname
...
The code up to line \ref{record:decl} amounts to the following Coq code
(when the value of the argument \elpi{ClassName} is \coq+class_of+):
...
In this simple case the number of fields, and hence the number of
binders, is fixed.
