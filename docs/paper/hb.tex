...
section~\ref{subsec:v3} wit the structure of semirings, which is another
...
%\begin{figure}[!h]
  \begin{tabular}{cc}
    \begin{minipage}{0.45 \textwidth}
      \begin{coqcode}
Elpi hb.declare_mixin
SemiRing_of_Monoid A Monoid.axioms.
  Record axioms := {
    one : A;
    mul : A -> A -> A;
...
(* Cyril, factories here? *)
  ...
  \end{minipage}
  \end{tabular}\\
%  \caption{\label{fig:puzzle}V4 introduces a join, for brevity we omit the factories/builders for the upper arrows}
%\end{figure}
