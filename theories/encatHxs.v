...
Lemma StrictDoubleCat_H1toH0_par (T : H1.StrictDoubleCat.type) :
  ...
  assert ((ecast x0 (D1hom x0 k) (comp1o h)
    (ecast y0 (D1hom (hunit a1 \; h) y0) (comp1o k)
       (HC2Comp_flat (unit_target a1 b1 (H1Source hk)))) = hk) = J).
  ...
  unfold HC2Comp_flat.
  simpl.
  unfold comp in J; simpl in J.
  subst vo1 vo2.
  simpl; simpl in *.
  unfold D1hom; simpl.
  unfold d1hom, H1Comp; simpl.
  unfold hhcomp, H2Unit; simpl.
